...
from fin_insight_graph_agent.retrieval.qdrant_client import QdrantSearchClient
...
class QdrantChunkIndexer:
    def __init__(self, client: QdrantSearchClient, dense_embedder, sparse_encoder) -> None:
        self._client = client
